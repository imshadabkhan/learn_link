...
class KidsController extends GetxController {
  Future<void> SubmitReport(BuildContext context,
      bool? diagnosedDyslexic) async {
    try {
      // Load saved scores
            ...
            content: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16),
                  Text("Scores Summary:", style: TextStyle(
                      fontWeight: FontWeight.bold, color: Colors.black)),
                  SizedBox(height: 8),
                  Text(
                    "Phoneme Matching: ${data["tasks"]["phonemeMatching"]["score"]}",
                    style: TextStyle(color: Colors.black),),
                  Text(
                    "Letter Recognition: ${data["tasks"]["letterRecognition"]["score"]}",
                    style: TextStyle(color: Colors.black),),
                  Text("Attention: ${data["tasks"]["attention"]["score"]}",
                    style: TextStyle(color: Colors.black),),
                  Text(
                    "Pattern Memory: ${data["tasks"]["patternMemory"]["score"]}",
                    style: TextStyle(color: Colors.black),),
                  SizedBox(height: 8),
                  Text("Model Diagnosis: $modelDiagnosis", style: TextStyle(
                      fontWeight: FontWeight.bold, color: Colors.black)),
