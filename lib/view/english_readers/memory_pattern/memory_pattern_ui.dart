...
import 'package:learn_link/view/english_readers/memory_pattern/controller.dart';
...
class PatternMemoryScreenForEnglishReaders extends StatelessWidget {
  final controller = Get.put(PatternMemoryControllerForEnglishReaders());
  ...
  PatternMemoryScreenForEnglishReaders({super.key});
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          onPressed: () => Get.toNamed(AppRoutes.writingScanner),
