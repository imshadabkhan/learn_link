...
import 'package:learn_link/view/english_readers/memory_pattern/memory_pattern_ui.dart';
import 'package:learn_link/view/english_readers/phoneme_matching/audio_quiz.dart';
...
class AppRoutes {
  ...
  static const  String audioQuizScreenForEnglishReaders="/audioQuizScreenForEnglishReaders";
  static const  String patternMemoryScreenForEnglishReaders="/patternMemoryScreenForEnglishReaders";
...
static final routes = [
  ...
  GetPage(name: audioQuizScreenForEnglishReaders, page:()=>AudioQuizScreenForEnglishReaders()),
  GetPage(name: patternMemoryScreenForEnglishReaders, page:()=>PatternMemoryScreenForEnglishReaders()),
